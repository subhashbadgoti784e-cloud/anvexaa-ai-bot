...
export const PUSH_TO_GITHUB_CONTENT = `#!/usr/bin/env bash
# =================================================================
...
export const DELIVERABLE_FILES: DeliverableFile[] = [
  ...
  {
    filename: 'push_to_github.sh',
    title: 'GitHub Upload Script',
    language: 'bash',
    description: 'Automates git init, commit of all files, and pushes directly to your GitHub repository in 1 click.',
    content: PUSH_TO_GITHUB_CONTENT
  },
  {
